...
const Home = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <article>
        <p>
          <span className="bold">A View on Access</span> was created in 2015 in conjunction with the Audio Description Association and from 2016 to June 2022 had a home on RNIB Connect. It was developed to create a better sense of access and inclusion in the arts and entertainment sector, that includes theatre, cinema, museums and galleries, attractions, conventions, events and sport for those blind and partially sighted - but also to provide an audio platform for other disabilities.
        </p>
        <p>
          Over the last 7 Years, <span className="bold">A View on Access</span> has gone from strength to strength, developing relationships with relevant companies, charities, venues and organisations in order to create better awareness of access and audio description.
        </p>
        <p>
      ...
      <article>
        ...
        <p>
          <span className="bold">A View on Access</span> is presented and produced by <em>Tim Calvert</em> of <em>Calvert Creative Concepts</em>.
        </p>
        <p>
